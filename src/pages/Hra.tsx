                        ...
                        <div className="container my-6">
                            <div className="header">
                                ...
                                <p className="italic text-lg text-gray-600 mb-4 my-3">
                                    Save more by smartly calculating your House
                                    Rent Allowance!
                                </p>
                            </div>
                            ...
                            <div className="bg-white p-6 rounded-md shadow-sm mt-5 text-gray-700 ">
                                ...
                                <p className="mb-3 text-sm">
                                    If you're a salaried professional, you could
                                    be missing out on significant tax benefits
                                    from House Rent Allowance (HRA). This tool
                                    helps you figure out exactly how much HRA
                                    you can claim as exemption — fast, simple,
                                    and accurate!
                                </p>
                                <p className="mb-3 text-sm">
                                ...
                                <Alert variant="destructive" className="my-5">
                                    <AlertTitle className="flex items-center gap-2 text-sm">
                                        <CircleAlert size={20} />
                                        <span>
                                            If you dont receive HRA, you can now
                                            claim up to{" "}
                                            <strong className="text-sm">
                                                ₹60,000 per year as rent paid
                                                under Section 80GG.
                                            </strong>
                                        </span>
                                    </AlertTitle>
                                ...
                                <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
                                    ...
                                    <p className="text-sm">
                                        Arun lives in Mumbai, earns
                                        ₹50,000/month, receives HRA of
                                        ₹25,000/month and pays ₹15,000/month as
                                        rent.
                                    </p>
