          ...
          <div className="container my-6">
            ...
            <div className="bg-white rounded-md shadow-sm mt-5 p-6 text-gray-700">
              ...
              <p className="mb-3 text-sm">
                ...
                amount at regular intervals—monthly, quarterly, or yearly. This
                disciplined approach helps you:
              </p>
              <ul className="list-disc list-outside pl-6 mb-3">
                <li>
                  <strong className="text-sm">Grow wealth steadily</strong> with
                ...
                <li>
                  <strong className="text-sm">Start small</strong> and increase
                  investments as your income grows
                </li>
                <li>
              ...
              <p className="mb-3 text-sm">
                Whether you’re a first-time investor or looking for a smart way
                to build financial discipline, SIP makes investing simple,
